										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												...
												<ul class="nav navbar-nav ">
													<li class="dropdown">
														<a class="dropdown-toggle" data-toggle="dropdown" href="template/index.html">Home</a>
														<ul class="dropdown-menu">
															<li><a href="template/index.html">Home Default</a></li>
															<li ><a href="template/index-corporate-1.html">Corporate 1</a></li>
															<li ><a href="template/index-corporate-2.html">Corporate 2</a></li>
															<li ><a href="template/index-corporate-3.html">Corporate 3</a></li>
															<li ><a href="template/index-shop.html">Commerce 1</a></li>
															<li ><a href="template/index-shop-2.html">Commerce 2</a></li>
															<li ><a href="template/index-portfolio.html">Portfolio/Agency</a></li>
															<li ><a href="template/index-medical.html">Medical</a></li>
															<li ><a href="template/index-restaurant.html">Restaurant</a></li>
															<li ><a href="template/index-wedding.html">Wedding</a></li>
															<li ><a href="template/index-landing.html">Landing Page</a></li>
															<li ><a href="template/page-coming-soon.html">Coming Soon</a></li>
															<li ><a href="template/index-one-page.html">One Page Version</a></li>
														</ul>
													</li>
													<!-- mega-menu start -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 text-center col-md-offset-2 space-bottom">
							...
							<p class="text-center lead object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">Multipurpose HTML5 Template - More than 140 HTML files.</p>
							...
							<ul class="list-inline">
								...
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200"><i class="icon-check text-default"></i> 5 Footer Options</li>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<div class="image-box bordered text-center mb-20">
								<img src="intro-images/demo-14.jpg" alt="">
							</div>
						</div>
						<div class="col-sm-4">
							<h3>More?</h3>
